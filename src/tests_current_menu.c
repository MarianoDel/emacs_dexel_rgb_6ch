...
int main(int argc, char *argv[])
{
    ...
    mem_conf.max_current_channels[0] = 0;
    mem_conf.max_current_channels[1] = 0;
    mem_conf.max_current_channels[2] = 0;
    ...
    do {
        ...
        resp = CurrentMenu(&mem_conf, action);
        ...
        if (resp == resp_finish)
        {
            ...
            sprintf(s_temp, "CH1: %03d CH2: %03d CH3: %03d CH4: %03d CH5: %03d CH6: %03d",
                    ...
                    mem_conf.max_current_channels[4],
                    mem_conf.max_current_channels[5]);
